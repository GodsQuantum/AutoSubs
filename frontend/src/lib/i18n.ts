...
const en = {
  ...
  save:'Save', saved:'Saved', delete:'Delete', create:'Create', close:'Close', select:'Select', browse:'Browse', back:'Back', refresh:'Refresh', new:'New', duplicate:'Duplicate',
  ...
  pop:'Pop', karaoke:'Karaoke', fade:'Fade', slideUp:'Slide up', bounce:'Bounce', animationNone:'None',
...
const fr: typeof en = {
  ...
  save:'Enregistrer', saved:'Enregistré', delete:'Supprimer', create:'Créer', close:'Fermer', select:'Sélectionner', browse:'Parcourir', back:'Retour', refresh:'Actualiser', new:'Nouveau', duplicate:'Dupliquer',
  ...
  auto:'Auto', libx264:'libx264', libx265:'libx265', nvencH264:'NVENC H.264', nvencHevc:'NVENC HEVC', qsvH264:'Intel QSV H.264', vaapiH264:'VA-API H.264', amfH264:'AMD AMF H.264',
  pop:'Pop', karaoke:'Karaoké', fade:'Fondu', slideUp:'Glissé haut', bounce:'Rebond', animationNone:'Aucune',
