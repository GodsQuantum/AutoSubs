...
const en = {
  ...
  uploadQueue:'Upload queue', uploadProgress:'Upload progress', noJobs:'No jobs yet', noJobsHint:'Drop a video or choose files to start.', edit:'Edit', render:'Render', renderVideo:'Render video', downloadVideo:'Download video', cancel:'Cancel', retry:'Retry', prepare:'Prepare',
  ...
  videoPreview:'Video preview', subtitles:'Subtitles', search:'Search', replace:'Replace', replaceAll:'Replace all', removeFinalPeriods:'Remove final periods', undoPunctuation:'Undo punctuation cleanup', finalPeriodsRemoved:'Final periods removed', shift:'Shift', milliseconds:'ms', seconds:'seconds',
  ...
  pop:'Pop', highlight:'Highlight', karaoke:'Karaoke', wordByWord:'Word by word', fade:'Fade', slideUp:'Slide up', bounce:'Bounce', animationNone:'None',
...
const fr: typeof en = {
  ...
  uploadQueue:"File d’import", uploadProgress:"Progression de l’import", noJobs:'Aucun job', noJobsHint:'Déposez une vidéo ou choisissez des fichiers pour commencer.', edit:'Éditer', render:'Rendre', renderVideo:'Rendre la vidéo', downloadVideo:'Télécharger la vidéo', cancel:'Annuler', retry:'Réessayer', prepare:'Préparer',
  ...
  videoPreview:'Aperçu vidéo', subtitles:'Sous-titres', search:'Rechercher', replace:'Remplacer', replaceAll:'Tout remplacer', removeFinalPeriods:'Supprimer les points finaux', undoPunctuation:'Annuler le nettoyage', finalPeriodsRemoved:'Points finaux supprimés', shift:'Décaler', milliseconds:'ms', seconds:'secondes',
  ...
  auto:'Auto', libx264:'libx264', libx265:'libx265', nvencH264:'NVENC H.264', nvencHevc:'NVENC HEVC', qsvH264:'Intel QSV H.264', vaapiH264:'VA-API H.264', amfH264:'AMD AMF H.264',
  pop:'Pop', highlight:'Surbrillance', karaoke:'Karaoké', wordByWord:'Mot par mot', fade:'Fondu', slideUp:'Glissé haut', bounce:'Rebond', animationNone:'Aucune',
