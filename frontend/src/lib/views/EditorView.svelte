      ...
      <aside class="editor-panel stack">
        <section class="card">
          ...
          <div class="card-body stack">
            <div class="field"><label for="editor-field-4">{$dictionary.preset}</label><select id="editor-field-4" class="select" bind:value={selectedPreset} on:change={applyPresetDefaults} disabled={locked}><option value="">{$dictionary.none}</option>{#each presets as p}<option value={p.id}>{p.name}</option>{/each}</select></div>
            <div class="grid two">
        ...
        <section class="card">
          ...
          <div class="card-body stack">
            <div class="grid two"><div class="field"><label for="editor-field-9">{$dictionary.maxChars}</label><input id="editor-field-9" class="input" type="number" min="5" max="42" bind:value={maxChars}/></div><div class="field"><label for="editor-field-10">{$dictionary.maxLines}</label><input id="editor-field-10" class="input" type="number" min="1" max="2" bind:value={maxLines}/></div></div>
