...
fn default_transcription_url() -> String {
    std::env::var("SPEACHES_URL").unwrap_or_else(|_| "http://speaches:8000/v1/audio/transcriptions".into())
}
...
impl Default for Settings {
    fn default() -> Self { serde_json::from_str("{}").expect("default settings are valid") }
}
...
impl JobStatus {
    pub fn is_active(&self) -> bool {
        matches!(self, Self::Pending | Self::Uploading | Self::Transcribing | Self::Burning)
    }
}
